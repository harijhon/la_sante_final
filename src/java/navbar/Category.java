...
public class Category {
    ...
    public static Category geNavbarDatasByIdMaladie(Connection con, String idMaladie, String title) throws Exception {
        ...
        while (rs.next()) {
            outPutTxt.add(rs.getString("nom_symptome"));
            outPutID.add(rs.getString("id_symptome"));
        }
    ...
    public static Category[] getAllDatasForCategories() throws Exception {
        Connection con = ConnectToDB.getConnection("postgres", "postgres", "root");
